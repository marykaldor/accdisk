# Calculate some r and divide by rmin to get B scaled by Bmax
# B = R^-q = (R/Rmin)^-q
...
def rrange(x, y, xcenter, ycenter):
    ...
    if 1 < cart2pol(x, y, xcenter, ycenter)[0] < rmax/rmin:
        return True
    else:
        return False
...
for x in range(1, xs):
    for y in range(1, ys):
        if rrange(x, y, xs/3, ys/2):
            normlistin.append(cart2pol(x, y, xs/3, ys/2)[0]**2)
...
img.show()
# img.save("/Users/marykaldor/accdisk/fortran/plaw-radscaled.png")
