...
# Makes the plot pretty and displays the image.
    ...
    # sd = statistics.stdev(noise)
    # plt.plot(noise, norm.pdf(noise, mean, sd))
    plt.xticks(fontname="Times New Roman")
    plt.yticks(fontname="Times New Roman")
    plt.xlabel("Noise", fontname="Times New Roman")
    plt.ylabel("Count", fontname="Times New Roman")
    plt.title("Count vs. Noise", fontname="Times New Roman")
    plt.savefig("/Users/marykaldor/accdisk/fortran/histogram_sn_histogram_" + str(k) + ".pdf")
    i += 1
    k += 1
